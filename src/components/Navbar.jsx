...
const Navbar = () => {
  ...
  return (
    <div className="max-w-[1640px] flex justify-between items-center mx-auto p-4">
      ...
      {/* mobile menu */}
      {/* overlay */}
      {nav ? (<div className="bg-black/80 top-0 absolute h-screen w-full z-10 left-0"></div>): ""}
      

      {/* side drawer menu */}
      <div className={nav ? "absolute w-[300px] top-0 left-0 h-screen bg-white duration-300 z-10" : "absolute w-[300px] top-0 left-[-100%] h-screen bg-white duration-300 z-10"}>
        <AiOutlineClose
          size={30}
